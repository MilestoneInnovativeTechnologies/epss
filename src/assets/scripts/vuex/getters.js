export function user(state){ return _.get(state['User'],'id') }
export function client(state){ return _.get(state['App'],'uuid') }
export function uuid(state){ return _.get(state['App'],'uuid') }
