...
export const set_organization_details = 'setInfo';
...
export const populate_organisation_data = 'setOrganisation';
export const populate_axios_url_data = 'setAxiosUrlData';
