<template>
    <AbsoluteLayout>
        <StackLayout width="100%">
            ...
            <AppForm title="Login" :fields="fields()" :values="{ login,password }" @final="$emit('credentials',$event)" />
        </StackLayout>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...mapState('User',['validating','password','pLogin']),
            login(){ return this.$store.state['User'].login || this.pLogin },
